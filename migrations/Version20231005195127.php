 ...
 */
final class Version20231005195127 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE demande_echange (id INT AUTO_INCREMENT NOT NULL, utilisateur_id INT NOT NULL, echange_id INT NOT NULL, produit_id INT NOT NULL, est_accepte TINYINT(1) NOT NULL, INDEX IDX_85805810FB88E14F (utilisateur_id), INDEX IDX_8580581013713818 (echange_id), UNIQUE INDEX UNIQ_85805810F347EFB (produit_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE echange (id INT AUTO_INCREMENT NOT NULL, produit_echange_id INT NOT NULL, utilisateur_id INT NOT NULL, statuts VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_B577E3BFBA490115 (produit_echange_id), INDEX IDX_B577E3BFFB88E14F (utilisateur_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE mission (id INT AUTO_INCREMENT NOT NULL, utilisateur_creer_id INT NOT NULL, utilisateur_accepter_id INT DEFAULT NULL, statuts VARCHAR(255) NOT NULL, description VARCHAR(255) NOT NULL, titre VARCHAR(255) NOT NULL, difficulte VARCHAR(255) NOT NULL, duree INT NOT NULL, urgence TINYINT(1) NOT NULL, INDEX IDX_9067F23CF17524D (utilisateur_creer_id), INDEX IDX_9067F23CBC314ABE (utilisateur_accepter_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
